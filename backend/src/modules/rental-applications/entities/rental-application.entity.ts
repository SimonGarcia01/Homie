...
export class RentalApplication extends TimestampEntity {
    ...
    @OneToMany(() => ApplicationApplicant, (applicant) => applicant.rentalApplication)
    applicants?: ApplicationApplicant[];

    @OneToMany(() => RentalEvaluation, (evaluation) => evaluation.rentalApplication)
    evaluations?: RentalEvaluation[];

    @OneToMany(() => RentalContract, (contract) => contract.rentalApplication)
    contracts?: RentalContract[];

    @OneToMany(() => ApplicationChecklistItem, (applicationChecklistItem) => applicationChecklistItem.rentalApplication)
