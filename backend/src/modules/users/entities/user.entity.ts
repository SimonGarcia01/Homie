...
export class User extends TimestampEntity {
    ...
    @OneToMany(() => AgentAvailability, (agentAvailability) => agentAvailability.user)
    ...
    @OneToMany(() => DocumentRecord, (documentRecord) => documentRecord.uploadedByUser)
    uploadedDocuments?: DocumentRecord[];

    @OneToMany(() => RentalEvaluation, (rentalEvaluation) => rentalEvaluation.evaluatedByUser)
