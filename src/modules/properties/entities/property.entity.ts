...
export class Property extends TimestampEntity {
  ...
  @OneToMany(
    () => PropertyAmenity,
    (propertyAmenity) => propertyAmenity.property,
  )
  ...
  @OneToOne(
    ...
    (propertyRentalDetail) => propertyRentalDetail.property,
  )
  ...
  @OneToMany(
    () => OpportunityProperty,
    (opportunityProperty) => opportunityProperty.property,
  )
  ...
  @OneToMany(
    () => RentalApplication,
    (rentalApplication) => rentalApplication.property,
  )
